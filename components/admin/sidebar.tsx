...
import { Home, List, Calendar, GanttChartSquare, ChevronsLeft, ChevronsRight, GraduationCap, Package, Users } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/dashboard/turmas", label: "Turmas", icon: Users },
];
